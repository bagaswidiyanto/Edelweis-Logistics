...
<div class="container-fluid text-light footer">
    <div class="container px-lg-5 pt-5 pb-3">
        <div class="row position-relative">
            <div class="col-lg-6 col-md-6 col-sm-12 mt-4">
                <div class="text-heading" data-aos="fade-up" data-aos-duration="2000">
                    <h1>OUR LOCATION</h1>
                </div>
                <div class="contact d-flex" data-aos="fade-up" data-aos-duration="2000">
                    <img class="img-fluid" src="<?= base_url(); ?>assets/imagenew/telpon-header.svg" alt="">
                    <div class="ms-4">
                        <?php
                ...
                <div class="email mt-2 mb-5 position-relative" data-aos="fade-up" data-aos-duration="2000">
                    <i class="fa fa-envelope"></i>
                    <p class="ms-5"><?= $website->email; ?></p>
                </div>
                <a href="https://wa.wizard.id/f165bb" target="_blank" class="btn-f py-2 px-4 px-sm-4 rounded-pill"
                    data-aos="fade-up" data-aos-duration="2000">Dapatkan Penawaran</a>
...
<div class="whatsapp-chat-section">
    ...
    <div id="whatsapp-chat-popup" class="animate__animated animate__bounceOutDown"
        ...
        <div id="list-chat-section" class="list-chat-section animate__animated animate__fadeIn" style="display: block;">
            <div class="header-section" style="background: linear-gradient(160.62deg, #FFF500 7.55%, #FDB600 121.38%);">
                ...
                <div class="header-avatar-section">
                    ...
                    <div class="avatar">
                        <img class="avatar"
                            ...
                            src="https://admin103.edelweislogistik.com/upload/wa_image/<?= $sec1->image; ?>">
                    </div>
                    <? } ?>
                </div>
            ...
            <div class="chat-section">
                ...
                <div class="cs-section" onclick="chatCustomer(<?= $sec2->id; ?>);">
                    <div class="avatar">
                        <img class="avatar"
                            src="https://admin103.edelweislogistik.com/upload/wa_image/<?= $sec2->image; ?>">
                    </div>
                    <div class="profile">
            ...
            <div class="header-section" style="background:linear-gradient(160.62deg, #FFF500 7.55%, #FDB600 121.38%);">
                ...
                <div class="header-avatar-section">
                    <div class="avatar">
                        <img class="avatar"
                            style="position: relative; display: inline-block; vertical-align: middle; height: 60px; width: 60px; border-radius: 60px;"
                            src="https://admin103.edelweislogistik.com/upload/wa_image/<?= $sec3->image; ?>">
                    </div>
                </div>
            ...
            <div class="inside-chat-section">
                <div class="chat">
                    <div class="inside-chat">
                        <span>Halo saya <?= ucwords(strtolower($sec3->nama)); ?>, dari Edelweis Logistik.</span>
                    </div>
                    <div class="time">
